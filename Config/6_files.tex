...
% \ntaddfile{appendix}{Chapters/appendices/app2_fff}
% \ntaddfile{appendix}{Chapters/appendices/app3_tomosim}
% \ntaddfile{appendix}{Chapters/appendices/app1_slr}
% \ntaddfile{appendix}{Chapters/appendices/app4_protocol}
% \ntaddfile{appendix}{Chapters/appendices/app5_telescopeCoupling}
% \ntaddfile{appendix}{Chapters/appendices/app6_telescopeDesign}
