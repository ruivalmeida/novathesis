...
% \ntaddfile{chapter}{2_bgAndMotivation}
% \ntaddfile{chapter}{3_theoreticalBg}
% \ntaddfile{chapter}{4_litreview}
\ntaddfile{chapter}{5_methods}
\ntaddfile{chapter}{6_discussion}
% \ntaddfile{chapter}{7_conclusion}
...
\ntaddfile{appendix}{app2_fff}
\ntaddfile{appendix}{app3_tomosim}
\ntaddfile{appendix}{app1_slr}
\ntaddfile{appendix}{app4_protocol}
\ntaddfile{appendix}{app5_telescopeCoupling}
\ntaddfile{appendix}{app6_telescopeDesign}
