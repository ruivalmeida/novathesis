...
\ntaddfile{chapter}{1_introduction}
\ntaddfile{chapter}{2_litreview}
\ntaddfile{chapter}{3_theoreticalBg}
\ntaddfile{chapter}{4_methods}
\ntaddfile{chapter}{5_discussion}
\ntaddfile{chapter}{6_conclusion}

%%------------------------------------------------------------
% Text appendices 
% syntax: \ntaddfile{appendix}{filename}
\ntaddfile{appendix}{Chapters/appendices/app2_fff.tex}
\ntaddfile{appendix}{Chapters/appendices/app3_tomosim.tex}
\ntaddfile{appendix}{Chapters/appendices/app1_slr.tex}
\ntaddfile{appendix}{Chapters/appendices/app4_protocol.tex}
\ntaddfile{appendix}{Chapters/appendices/app5_telescopeCoupling.tex}
\ntaddfile{appendix}{Chapters/appendices/app6_telescopeDesign.tex}

% \ntaddfile{appendix}{appendices/app2_fff}
% \ntaddfile{appendix}{appendices/app3_tomosim}
% \ntaddfile{appendix}{appendices/app1_slr}
% \ntaddfile{appendix}{appendices/app4_protocol}
% \ntaddfile{appendix}{appendices/app5_telescopeCoupling}
% \ntaddfile{appendix}{appendices/app6_telescopeDesign}
