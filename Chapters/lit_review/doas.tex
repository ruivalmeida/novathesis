...
well defined, impulse-like narrow structures (for instance, the narrow
line for mercury at xxx nm~\todo{check this, citation (Fayt, diss)}).
For most spectrometers, this step is not actually required, as
manufacturers already provide a very accurate spectral resolution value.
...
used in \gls{DOAS} calculations, they have to be re-discretised onto the
experiment's spectrometer sensor resolution.
